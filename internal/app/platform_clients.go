...
func newQQNapcatClient(logger base.Logger) (base.Client, error) {
	if logger == nil {
...
func newTelegramBotClient(logger base.Logger) (base.Client, error) {
	if logger == nil {
		logger = base.NewDiscardLogger()
	}
	cfg := tgbot.Config{
...
func newTelegramUserClient(logger base.Logger) (base.Client, error) {
	if logger == nil {
		logger = base.NewDiscardLogger()
	}
	cfg := tguser.Config{
...
func newFeishuClient(logger base.Logger) (base.Client, error) {
	if logger == nil {
		logger = base.NewDiscardLogger()
	}
	cfg := feishu.Config{
